...
import ir.roohi.farshid.reminderpro.databinding.ActivityAlarmBinding
...
class AlarmActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       binding.txtDescription.text = locationEntity.text
        binding.txtTitle.text = locationEntity.title
